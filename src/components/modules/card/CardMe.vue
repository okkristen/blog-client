<template>
  <el-card>
    <h1 class="me-author-name">ok克里斯汀</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;浙江&温州</span>
...
export default {
  ...
  data () {
    return {
      qq: {title: 'QQ', message: '402605042'},
      github: {
        title: 'github',
        message: '<a target="_blank" href="https://github.com/okkristen">https://github.com/okkristen</a>'
      }
    }
  },
  methods: {
